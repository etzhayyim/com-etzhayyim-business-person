...
(defn collection
  [name]
  (str "com.etzhayyim.business-person." name))
...
(def cell-specs {
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :person {:legacy-cell "com-etzhayyim-apps-businessPerson-person"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "person")]
     :required-gates common-gates
     :trigger "manifest cell person"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :officerrole {:legacy-cell "com-etzhayyim-apps-businessPerson-officerRole"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "officerrole")]
     :required-gates common-gates
     :trigger "manifest cell officerrole"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :boardmembership {:legacy-cell "com-etzhayyim-apps-businessPerson-boardMembership"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "boardmembership")]
     :required-gates common-gates
     :trigger "manifest cell boardmembership"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :affiliation {:legacy-cell "com-etzhayyim-apps-businessPerson-affiliation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "affiliation")]
     :required-gates common-gates
     :trigger "manifest cell affiliation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :personnelchange {:legacy-cell "com-etzhayyim-apps-businessPerson-personnelChange"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "personnelchange")]
     :required-gates common-gates
     :trigger "manifest cell personnelchange"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :collectionjob {:legacy-cell "com-etzhayyim-apps-businessPerson-collectionJob"
     :phase :event
     :murakumo-node "reuben"
